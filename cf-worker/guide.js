    ...
    <main>
      ...
      <section id="power">
        ...
        <ul>
          ...
          <li data-l="he"><strong>בקר (״המוח״)</strong> — <span class="mono">ESP32</span> קטן שמריץ את התוכנה החינמית <a href="https://kno.wled.ge/" target="_blank" rel="noopener">WLED</a>: עשרות אפקטים, שליטה מהטלפון דרך וויי־פיי, בלי לכתוב שורת קוד.</li>
          <li data-l="en"><strong>Controller (the "brain")</strong> — a small <span class="mono">ESP32</span> running the free <a href="https://kno.wled.ge/" target="_blank" rel="noopener">WLED</a> software: dozens of effects, phone control over Wi‑Fi, no coding at all.</li>
